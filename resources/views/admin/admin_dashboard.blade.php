            ...
            <nav class="mt-5">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item {{ Request::is('admin_home') ? 'active' : '' }}">
                        <a href="{{\URL::to('/admin_home')}}" class="nav-link" style="color: #000000;">
                            <!-- Change color here -->
                    ...
                    <li class="nav-item {{ Request::is('addProduct') ? 'active' : '' }}">
                        <a href="{{\URL::to('/addProduct')}}" class="nav-link" style="color: #000000;">
                            <!-- Change color here -->
                    ...
                    <!-- View Orders Link -->
                    <li class="nav-item {{ Request::is('view_orders') ? 'active' : '' }}">
                        <a href="{{\URL::to('/view_orders')}}" class="nav-link" style="color: #000000;">
                            <!-- Change color here -->
